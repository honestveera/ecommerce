...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference("Subcategory.count") do
      post subcategories_url, params: { subcategory: { book_category_id: @subcategory.book_category_id, name: @subcategory.name } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { book_category_id: @subcategory.book_category_id, name: @subcategory.name } }
